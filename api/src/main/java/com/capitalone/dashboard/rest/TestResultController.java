...
public class TestResultController {
    ...
    @RequestMapping(value = "/quality/historyTest", method = GET, produces = APPLICATION_JSON_VALUE)
    public DataResponse<Iterable<TestResult>> historyData(@RequestParam(value = "component", required = true) String componentId,
    		@RequestParam(value = "jobName", required = true) String jobName) {
        return testResultService.historySearch(componentId,jobName);
    }
