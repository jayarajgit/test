(function () {
    ...
    TestDetailsController.$inject = ['$scope','$modalInstance', 'testHistoryResult', 'DashStatus'];
    function TestDetailsController($scope, $modalInstance, testHistoryResult, DashStatus) {
        /*jshint validthis:true */
        var ctrl = this;
        
        ctrl.statuses = DashStatus;
        ctrl.testHistoryResult = testHistoryResult;
        ctrl.duration = msToTime(testHistoryResult.duration);
        ctrl.close = close;
